import{_ as e}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as n,c as s,e as i}from"./app-DL4rFebn.js";const a="/assets/image-20241115213347331-Bk7WFnui.png",t="/assets/image-20240404173439745-DeYHt9xp.png",l="/assets/image-20240407155234695-7NEfnLtQ.png",o="/assets/1712962768897-14c5a7cb-83fd-41d8-a986-ddcf39649a7e-BQXPdHfH.png",c={},d=i('<h2 id="本质-私密仓库的内容推送到公开仓库" tabindex="-1"><a class="header-anchor" href="#本质-私密仓库的内容推送到公开仓库"><span>本质：私密仓库的内容推送到公开仓库</span></a></h2><p>不想直接公开源代码，可以使用的 <strong><u>私有仓库</u></strong> 存放源代码，再推送到公开仓库</p><h2 id="_1-生成部署用的-ssh-key" tabindex="-1"><a class="header-anchor" href="#_1-生成部署用的-ssh-key"><span>1. 生成部署用的 <code>SSH KEY</code></span></a></h2><p>前</p><h3 id="_2-在控制台公开仓库部署key" tabindex="-1"><a class="header-anchor" href="#_2-在控制台公开仓库部署key"><span>2. 在控制台公开仓库部署KEY</span></a></h3><figure><img src="'+a+'" alt="image-20241115213347331" tabindex="0" loading="lazy"><figcaption>image-20241115213347331</figcaption></figure><p>注意勾选<code>Allow write access</code>，这样才能把私有仓库的内容写入</p><h3 id="_3-新建一个私密仓库" tabindex="-1"><a class="header-anchor" href="#_3-新建一个私密仓库"><span>3. 新建一个私密仓库</span></a></h3><figure><img src="'+t+`" alt="image-20240404173439745" tabindex="0" loading="lazy"><figcaption>image-20240404173439745</figcaption></figure><h3 id="_4-更改deploy-to-blog-yml文件" tabindex="-1"><a class="header-anchor" href="#_4-更改deploy-to-blog-yml文件"><span>4. 更改<code>deploy_to_blog.yml</code>文件</span></a></h3><p>:::</p><h4 id="对应的推送代码的参考" tabindex="-1"><a class="header-anchor" href="#对应的推送代码的参考"><span>对应的推送代码的参考</span></a></h4><p>把这段内容粘贴到<code>deploy_to_blog.yml</code>里面，替换掉之前的内容（之前模版内会有一个<code>deploy_to_blog.yml</code>，但是只适用于公开仓库）</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># .github/workflows/deploy_to_blog.yml</span>
