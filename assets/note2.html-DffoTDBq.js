import{_ as v}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as d,o as u,c as m,a as e,b as i,d as a,w as n,e as t}from"./app-D4ncW6wD.js";const b={},p=t(`<h2 id="类的概念-公有和私有" tabindex="-1"><a class="header-anchor" href="#类的概念-公有和私有"><span><code>类</code>的概念，公有和私有</span></a></h2><div class="language-c++ line-numbers-mode" data-ext="c++" data-title="c++"><pre class="language-c++"><code>#include&lt;iostream&gt; // 类似于c中的#include &lt;stdio.h&gt; ，由于C++于c是被继承关系，所以也可以写&lt;stdio.h&gt; 。但是&lt;iostream&gt;有所扩展（比如说这个class，c中是没有的）
#include&lt;string&gt;
